        ...
        <div class="flex flex-row h-full w-full overflow-x-hidden">
          ...
          <div class="flex flex-col flex-auto h-full p-6">
            ...
            <select  onchange="location = this.value;"  id="selectbot" class="w-[200px] ml-auto  border  border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500   p-2 ">
                ...
                <option class="text-gray-900" value="mark" selected>Chatbot Mark</option>
                <option class="text-gray-900" value="cody" selected>Chatbot Cody</option>
                  ...
                  <div class="grid grid-cols-12 gap-y-2">
                    ...
                    <div class="col-start-6 col-end-13 p-3 rounded-lg">
                      <div class="flex items-center justify-start flex-row-reverse">
                        <div
                          class="flex items-center justify-center h-10 w-10 rounded-full bg-orange-500 flex-shrink-0 text-white"
                        >
                          A
                        </div>
                        <div
...
background: linear-gradient(186deg, rgba(26,26,26,1) 1%, rgba(115,115,115,1) 50%, rgba(204,204,204,1) 100%);
        ...
        #selectbot{
            background: linear-gradient(186deg, rgba(249,103,67,1) 1%, rgba(255,199,0,1) 100%);
