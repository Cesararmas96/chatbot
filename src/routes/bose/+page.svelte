<script lang="ts">
    ...
    const handleSubmit = async (event) => {
      ...
      const apiUrl = "https://ai-dev.trocdigital.net/api/v1/chat/Bose";
      ...
      <div class="flex flex-col flex-auto h-full p-6">
        <div class="flex flex-col flex-auto flex-shrink-0 bg-white h-full p-4">
          ...
          >
            ...
            >
            <option class="text-gray-900" value="bose" selected>Bose Chatbot</option>
          </select>
                ...
                {#each messages as message}
                  ...
                  <div class="col-start-6 col-end-13 p-3 rounded-lg">
                    <div class="flex items-center justify-start flex-row-reverse">
                      <div
                        class="uppercase flex items-center justify-center h-10 w-10 rounded-full bg-gray-600 flex-shrink-0 text-white"
                      >
                      {username}
                      </div>
                      <div
          ...
          <form on:submit={handleSubmit}>
            ...
            >
              ...
              <div class="ml-4">
                <button
                  type="submit"
                  class="flex items-center justify-center bg-gray-600 hover:bg-gray-700 rounded-full text-white px-3 py-3 flex-shrink-0"
                >
                  <span class="">
                    <svg
  ...
  <style>
         #navbar{
background: linear-gradient(186deg, rgba(26,26,26,1) 1%, rgba(115,115,115,1) 50%, rgba(204,204,204,1) 100%);
