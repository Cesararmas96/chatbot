    ...
    <div class="flex flex-col">
      <div class="relative ml-3 text-sm bg-white py-2 px-4 shadow rounded-xl">
        ...
        <div class="flex justify-end mt-5 mb-2">
          ...
          {#if last === 'true'}
          <button class="mr-4 "  on:click={() => handleRegenerate(message.query)}  title="Regenerate" >
            <svg
              width="17"
              height="17"
              class="svg actions"
      ...
      {#if like}
      <BotMessageLike {message} on:close={() => (like = false)} />
      {:else if dislike}
