                  ...
                  <div class="grid grid-cols-12 gap-y-2">
                    ...
                    <div class="col-start-6 col-end-13 p-3 rounded-lg">
                      <div class="flex items-center justify-start flex-row-reverse">
                        <div
                          class="flex items-center justify-center h-10 w-10 rounded-full bg-blue-800 flex-shrink-0 text-white"
                        >
                          A
                        </div>
                        <div
              ...
              >
                ...
                <div class="ml-4">
                  <button type="button" on:click={handleSubmit}
                    class="flex items-center justify-center bg-blue-800 hover:bg-blue-900 rounded-full text-white px-3 py-3 flex-shrink-0"
                  >
                    <span class="">
                      <svg
